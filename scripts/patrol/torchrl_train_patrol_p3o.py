...
def main(cfg: "DictConfig"):  # noqa: F821
    ...
    if load_model:
        ...
        run_id = "2024-02-02/06-22-05/"
        model_load_filename = "PPO_PPO_PatrolEnvGrid_e2df98a5_24_02_02-06_22_07_ppo_iter_800.pt"
    ...
    for i, data in enumerate(collector):
        ...
        for j in range(cfg_loss_ppo_epochs):
            ...
            # Compute GAE
            with torch.no_grad():
                data = adv_module(data.to(device, non_blocking=False))
