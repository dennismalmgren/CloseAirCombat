...
from utils_agac import make_ppo_models, make_parallel_env, eval_model

@hydra.main(config_path=".", config_name="config_agac", version_base="1.1")
def main(cfg: "DictConfig"):  # noqa: F821
    ...
    actor, critic, common_module_adv, policy_module_adv = make_ppo_models(device)
